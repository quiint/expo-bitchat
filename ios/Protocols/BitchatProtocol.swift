...
public struct DeliveryAck: Codable {
    ...
    public static func decode(from data: Data) -> DeliveryAck? {
...
public struct ReadReceipt: Codable {
    ...
    public let readerID: String  // Who read it
    public let readerNickname: String
    public let timestamp: Date
    
    public init(originalMessageID: String, readerID: String, readerNickname: String) {
        self.originalMessageID = originalMessageID
...
public struct BitchatMessage: Codable, Equatable {
    ...
    public let channel: String?  // Channel hashtag (e.g., "#general")
    public let encryptedContent: Data?  // For password-protected rooms
    public let isEncrypted: Bool  // Flag to indicate if content is encrypted
