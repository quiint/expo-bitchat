...
class EncryptionService(private val context: android.content.Context) {
    init {
    ...
    fun decryptWithSymmetricKeyToString(data: ByteArray, key: SecretKeySpec): String? {
    return try {
    ...
    fun encryptWithSymmetricKey(data: ByteArray, key: SecretKeySpec): ByteArray? {
        return try {
    ...
    fun decryptWithSymmetricKey(data: ByteArray, key: SecretKeySpec): ByteArray? {
        return try {
